---@alias EVDEV_INPUT_CONSTANT_ID "'ID_BUS'"|"'ID_VENDOR'"|"'ID_PRODUCT'"|"'ID_VERSION'"
...
---@alias EVDEV_INPUT_CONSTANT_BUS "'BUS_PCI'"|"'BUS_ISAPNP'"|"'BUS_USB'"|"'BUS_HIL'"|"'BUS_BLUETOOTH'"|"'BUS_VIRTUAL'"|"'BUS_ISA'"|"'BUS_I8042'"|"'BUS_XTKBD'"|"'BUS_RS232'"|"'BUS_GAMEPORT'"|"'BUS_PARPORT'"|"'BUS_AMIGA'"|"'BUS_ADB'"|"'BUS_I2C'"|"'BUS_HOST'"|"'BUS_GSC'"|"'BUS_ATARI'"|"'BUS_SPI'"|"'BUS_RMI'"|"'BUS_CEC'"|"'BUS_INTEL_ISHTP'"
...
---@alias EVDEV_INPUT_CONSTANT_MT_TOOL "'MT_TOOL_FINGER'"|"'MT_TOOL_PEN'"|"'MT_TOOL_PALM'"|"'MT_TOOL_DIAL'"|"'MT_TOOL_MAX'"
...
---@alias EVDEV_INPUT_CONSTANT_INPUT_PROP "'INPUT_PROP_POINTER'"|"'INPUT_PROP_DIRECT'"|"'INPUT_PROP_BUTTONPAD'"|"'INPUT_PROP_SEMI_MT'"|"'INPUT_PROP_TOPBUTTONPAD'"|"'INPUT_PROP_POINTING_STICK'"|"'INPUT_PROP_ACCELEROMETER'"|"'INPUT_PROP_MAX'"|"'INPUT_PROP_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_EV "'EV_VERSION'"|"'EV_SYN'"|"'EV_KEY'"|"'EV_REL'"|"'EV_ABS'"|"'EV_MSC'"|"'EV_SW'"|"'EV_LED'"|"'EV_SND'"|"'EV_REP'"|"'EV_FF'"|"'EV_PWR'"|"'EV_FF_STATUS'"|"'EV_MAX'"|"'EV_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_SYN "'SYN_REPORT'"|"'SYN_CONFIG'"|"'SYN_MT_REPORT'"|"'SYN_DROPPED'"|"'SYN_MAX'"|"'SYN_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_REL "'REL_X'"|"'REL_Y'"|"'REL_Z'"|"'REL_RX'"|"'REL_RY'"|"'REL_RZ'"|"'REL_HWHEEL'"|"'REL_DIAL'"|"'REL_WHEEL'"|"'REL_MISC'"|"'REL_RESERVED'"|"'REL_WHEEL_HI_RES'"|"'REL_HWHEEL_HI_RES'"|"'REL_MAX'"|"'REL_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_MSC "'MSC_SERIAL'"|"'MSC_PULSELED'"|"'MSC_GESTURE'"|"'MSC_RAW'"|"'MSC_SCAN'"|"'MSC_TIMESTAMP'"|"'MSC_MAX'"|"'MSC_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_SW "'SW_LID'"|"'SW_TABLET_MODE'"|"'SW_HEADPHONE_INSERT'"|"'SW_RFKILL_ALL'"|"'SW_RADIO'"|"'SW_MICROPHONE_INSERT'"|"'SW_DOCK'"|"'SW_LINEOUT_INSERT'"|"'SW_JACK_PHYSICAL_INSERT'"|"'SW_VIDEOOUT_INSERT'"|"'SW_CAMERA_LENS_COVER'"|"'SW_KEYPAD_SLIDE'"|"'SW_FRONT_PROXIMITY'"|"'SW_ROTATE_LOCK'"|"'SW_LINEIN_INSERT'"|"'SW_MUTE_DEVICE'"|"'SW_PEN_INSERTED'"|"'SW_MACHINE_COVER'"|"'SW_MAX'"|"'SW_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_LED "'LED_NUML'"|"'LED_CAPSL'"|"'LED_SCROLLL'"|"'LED_COMPOSE'"|"'LED_KANA'"|"'LED_SLEEP'"|"'LED_SUSPEND'"|"'LED_MUTE'"|"'LED_MISC'"|"'LED_MAIL'"|"'LED_CHARGING'"|"'LED_MAX'"|"'LED_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_SND "'SND_CLICK'"|"'SND_BELL'"|"'SND_TONE'"|"'SND_MAX'"|"'SND_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_REP "'REP_DELAY'"|"'REP_PERIOD'"|"'REP_MAX'"|"'REP_CNT'"
...
---@alias EVDEV_INPUT_CONSTANT_PWR nil

local PWR = {}

---@alias EVDEV_INPUT_CONSTANT_FF_STATUS "'FF_STATUS_STOPPED'"|"'FF_STATUS_PLAYING'"|"'FF_STATUS_MAX'"
...
---@alias EVDEV_INPUT_CONSTANT EVDEV_INPUT_CONSTANT_ID|EVDEV_INPUT_CONSTANT_BUS|EVDEV_INPUT_CONSTANT_MT_TOOL|EVDEV_INPUT_CONSTANT_INPUT_PROP|EVDEV_INPUT_CONSTANT_EV|EVDEV_INPUT_CONSTANT_SYN|EVDEV_INPUT_CONSTANT_KEY|EVDEV_INPUT_CONSTANT_REL|EVDEV_INPUT_CONSTANT_ABS|EVDEV_INPUT_CONSTANT_MSC|EVDEV_INPUT_CONSTANT_SW|EVDEV_INPUT_CONSTANT_LED|EVDEV_INPUT_CONSTANT_SND|EVDEV_INPUT_CONSTANT_REP|EVDEV_INPUT_CONSTANT_FF|EVDEV_INPUT_CONSTANT_PWR|EVDEV_INPUT_CONSTANT_FF_STATUS
