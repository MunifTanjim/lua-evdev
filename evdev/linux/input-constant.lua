...
---@alias EVDEV_INPUT_BUS_CONSTANT_NAME "'BUS_PCI'"|"'BUS_ISAPNP'"|"'BUS_USB'"|"'BUS_HIL'"|"'BUS_BLUETOOTH'"|"'BUS_VIRTUAL'"|"'BUS_ISA'"|"'BUS_I8042'"|"'BUS_XTKBD'"|"'BUS_RS232'"|"'BUS_GAMEPORT'"|"'BUS_PARPORT'"|"'BUS_AMIGA'"|"'BUS_ADB'"|"'BUS_I2C'"|"'BUS_HOST'"|"'BUS_GSC'"|"'BUS_ATARI'"|"'BUS_SPI'"|"'BUS_RMI'"|"'BUS_CEC'"|"'BUS_INTEL_ISHTP'"|"'BUS_AMD_SFH'"
...
---@alias EVDEV_INPUT_MT_TOOL_CONSTANT_NAME "'MT_TOOL_FINGER'"|"'MT_TOOL_PEN'"|"'MT_TOOL_PALM'"|"'MT_TOOL_DIAL'"|"'MT_TOOL_MAX'"
...
---@alias EVDEV_INPUT_INPUT_PROP_CONSTANT_NAME "'INPUT_PROP_POINTER'"|"'INPUT_PROP_DIRECT'"|"'INPUT_PROP_BUTTONPAD'"|"'INPUT_PROP_SEMI_MT'"|"'INPUT_PROP_TOPBUTTONPAD'"|"'INPUT_PROP_POINTING_STICK'"|"'INPUT_PROP_ACCELEROMETER'"|"'INPUT_PROP_MAX'"|"'INPUT_PROP_CNT'"
...
---@alias EVDEV_INPUT_EV_CONSTANT_NAME "'EV_VERSION'"|"'EV_SYN'"|"'EV_KEY'"|"'EV_REL'"|"'EV_ABS'"|"'EV_MSC'"|"'EV_SW'"|"'EV_LED'"|"'EV_SND'"|"'EV_REP'"|"'EV_FF'"|"'EV_PWR'"|"'EV_FF_STATUS'"|"'EV_MAX'"|"'EV_CNT'"
...
---@alias EVDEV_INPUT_SYN_CONSTANT_NAME "'SYN_REPORT'"|"'SYN_CONFIG'"|"'SYN_MT_REPORT'"|"'SYN_DROPPED'"|"'SYN_MAX'"|"'SYN_CNT'"
...
local KEY = {
  ...
  KEY_DIRECTION = 153, -- KEY_ROTATE_DISPLAY
  ...
  KEY_DASHBOARD = 204, -- KEY_ALL_APPLICATIONS
  KEY_SUSPEND = 205,
  KEY_CLOSE = 206,
  KEY_PLAY = 207,
  KEY_FASTFORWARD = 208,
  ...
  KEY_BRIGHTNESS_ZERO = 244, -- KEY_BRIGHTNESS_AUTO
  KEY_DISPLAY_OFF = 245,
  KEY_WWAN = 246,
  ...
  KEY_MIN_INTERESTING = 113, -- KEY_MUTE
  KEY_MAX = 0x2ff,
  KEY_CNT = (0x2ff + 1), -- (KEY_MAX+1)
}

---@alias EVDEV_INPUT_REL_CONSTANT_NAME "'REL_X'"|"'REL_Y'"|"'REL_Z'"|"'REL_RX'"|"'REL_RY'"|"'REL_RZ'"|"'REL_HWHEEL'"|"'REL_DIAL'"|"'REL_WHEEL'"|"'REL_MISC'"|"'REL_RESERVED'"|"'REL_WHEEL_HI_RES'"|"'REL_HWHEEL_HI_RES'"|"'REL_MAX'"|"'REL_CNT'"
...
---@alias EVDEV_INPUT_MSC_CONSTANT_NAME "'MSC_SERIAL'"|"'MSC_PULSELED'"|"'MSC_GESTURE'"|"'MSC_RAW'"|"'MSC_SCAN'"|"'MSC_TIMESTAMP'"|"'MSC_MAX'"|"'MSC_CNT'"
...
---@alias EVDEV_INPUT_SW_CONSTANT_NAME "'SW_LID'"|"'SW_TABLET_MODE'"|"'SW_HEADPHONE_INSERT'"|"'SW_RFKILL_ALL'"|"'SW_RADIO'"|"'SW_MICROPHONE_INSERT'"|"'SW_DOCK'"|"'SW_LINEOUT_INSERT'"|"'SW_JACK_PHYSICAL_INSERT'"|"'SW_VIDEOOUT_INSERT'"|"'SW_CAMERA_LENS_COVER'"|"'SW_KEYPAD_SLIDE'"|"'SW_FRONT_PROXIMITY'"|"'SW_ROTATE_LOCK'"|"'SW_LINEIN_INSERT'"|"'SW_MUTE_DEVICE'"|"'SW_PEN_INSERTED'"|"'SW_MACHINE_COVER'"|"'SW_MAX'"|"'SW_CNT'"
...
local SW = {
  ...
  SW_MAX = 0x10,
  SW_CNT = (0x10 + 1), -- (SW_MAX+1)
}

---@alias EVDEV_INPUT_LED_CONSTANT_NAME "'LED_NUML'"|"'LED_CAPSL'"|"'LED_SCROLLL'"|"'LED_COMPOSE'"|"'LED_KANA'"|"'LED_SLEEP'"|"'LED_SUSPEND'"|"'LED_MUTE'"|"'LED_MISC'"|"'LED_MAIL'"|"'LED_CHARGING'"|"'LED_MAX'"|"'LED_CNT'"
...
---@alias EVDEV_INPUT_SND_CONSTANT_NAME "'SND_CLICK'"|"'SND_BELL'"|"'SND_TONE'"|"'SND_MAX'"|"'SND_CNT'"
...
---@alias EVDEV_INPUT_REP_CONSTANT_NAME "'REP_DELAY'"|"'REP_PERIOD'"|"'REP_MAX'"|"'REP_CNT'"
...
---@alias EVDEV_INPUT_FF_CONSTANT_NAME "'FF_STATUS_STOPPED'"|"'FF_STATUS_PLAYING'"|"'FF_STATUS_MAX'"|"'FF_RUMBLE'"|"'FF_PERIODIC'"|"'FF_CONSTANT'"|"'FF_SPRING'"|"'FF_FRICTION'"|"'FF_DAMPER'"|"'FF_INERTIA'"|"'FF_RAMP'"|"'FF_EFFECT_MIN'"|"'FF_EFFECT_MAX'"|"'FF_SQUARE'"|"'FF_TRIANGLE'"|"'FF_SINE'"|"'FF_SAW_UP'"|"'FF_SAW_DOWN'"|"'FF_CUSTOM'"|"'FF_WAVEFORM_MIN'"|"'FF_WAVEFORM_MAX'"|"'FF_GAIN'"|"'FF_AUTOCENTER'"|"'FF_MAX_EFFECTS'"|"'FF_MAX'"|"'FF_CNT'"
...
---@alias EVDEV_INPUT_PWR_CONSTANT_NAME nil

local PWR = {}

---@alias EVDEV_INPUT_FF_STATUS_CONSTANT_NAME "'FF_STATUS_STOPPED'"|"'FF_STATUS_PLAYING'"|"'FF_STATUS_MAX'"
...
---@alias EVDEV_INPUT_CONSTANT_NAME EVDEV_INPUT_ID_CONSTANT_NAME|EVDEV_INPUT_BUS_CONSTANT_NAME|EVDEV_INPUT_MT_TOOL_CONSTANT_NAME|EVDEV_INPUT_INPUT_PROP_CONSTANT_NAME|EVDEV_INPUT_EV_CONSTANT_NAME|EVDEV_INPUT_SYN_CONSTANT_NAME|EVDEV_INPUT_KEY_CONSTANT_NAME|EVDEV_INPUT_REL_CONSTANT_NAME|EVDEV_INPUT_ABS_CONSTANT_NAME|EVDEV_INPUT_MSC_CONSTANT_NAME|EVDEV_INPUT_SW_CONSTANT_NAME|EVDEV_INPUT_LED_CONSTANT_NAME|EVDEV_INPUT_SND_CONSTANT_NAME|EVDEV_INPUT_REP_CONSTANT_NAME|EVDEV_INPUT_FF_CONSTANT_NAME|EVDEV_INPUT_PWR_CONSTANT_NAME|EVDEV_INPUT_FF_STATUS_CONSTANT_NAME
